...
class Pitching2022 extends Component {
    constructor(props) {
        super(props);
        ...
        const sortedPlayerData = [...playerData2022].sort((a, b) => a.era - b.era);
    ...
    render() {
        ...
        return (
            <div className="pitching-container">
                ...
                <h1 className="minibats-title">2022 Pitching Stats</h1>
