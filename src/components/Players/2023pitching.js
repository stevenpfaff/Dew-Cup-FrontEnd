...
class Pitching2023 extends Component {
    constructor(props) {
        super(props);

        const playerData2023 = data
            .filter((player) => player["2023_stats"] && player["2023_stats"].mbgames > 0)
            .map((player) => {
                const stats2023 = player["2023_stats"];
                return {
                    ...player,
                    ...stats2023,
                };
        ...
        const sortedPlayerData = [...playerData2023].sort((a, b) => a.era - b.era);
    ...
    sortData = (key) => {
        ...
        if (key === 'era') {
            const qualifiers = player.filter((p) => p.ip >= 10);
            const nonQualifiers = player.filter((p) => p.ip > 0 && p.ip < 10);
    ...
    render() {
        ...
        return (
            <div className="pitching-container">
                ...
                <h1 className="minibats-title">2023 Pitching Stats</h1>
