...
class Pitching2021 extends Component {
    constructor(props) {
        super(props);
        ...
        const sortedPlayerData = [...playerData2021].sort((a, b) => a.era - b.era);
    ...
    render() {
        ...
        return (
            <div className="pitching-container">
                ...
                <h1 className="minibats-title">2021 Pitching Stats</h1>
